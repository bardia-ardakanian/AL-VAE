VAE-Active-Learning-Object-Detection

Code for training an active learning model for object detection using a Variational Autoencoder (VAE). The model uses VAE to select the most informative data for training, resulting in better accuracy and faster convergence. Implemented using Python and PyTorch.
